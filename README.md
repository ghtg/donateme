...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/ghtg/donateme/main/README.md'))()")
...
if game:GetService("CoreGui").imgui.Windows.Window.Title.Text == "Loading..." then
    game:GetService("CoreGui").imgui.Windows.Window.Title.Text = "PLS DONATE - fantomtmn34"
end
